...
//    VehiclePlant RollsPlant = new VehiclePlant("Lamborghini", 11, valoresIniciales[0], valoresIniciales[1], true);
    ...
    public void setRollsPlant(EstudioAnimacion RollsPlant){
        this.RollsPlant = RollsPlant;
        setWorkersSpinners();
        setWorkersLeft();
        GlobalUI.getMainUI().getMainDashboard().getDeadlineSpinner().setValue(RollsPlant.entrega);
        //this.DeadlineSpinner.setValue();
    }
           
    public void setWorkersLeft(){
        int cantidadActual = Functions.calcWorkersQty(RollsPlant.emplxDep);
    ...
    public void setWorkersSpinners(){
        this.qtyWChasis.setValue(RollsPlant.emplxDep[0]);
        this.qtyWCarroceria.setValue(RollsPlant.emplxDep[1]);
        this.qtyWMotor.setValue(RollsPlant.emplxDep[2]);
        this.qtyWAcc.setValue(RollsPlant.emplxDep[3]);
        this.qtyWRuedas.setValue(RollsPlant.emplxDep[4]);
        this.qtyWEnsamblador.setValue(RollsPlant.emplxDep[5]);
    }
    ...
    private void initComponents() {
        ...
        workerEnsamblador.setText("Guionista");
        add(workerEnsamblador, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 390, -1, 30));
        ...
        add(qtyWEnsamblador, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 350, -1, 30));
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 470, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setText("Escenario");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 470, -1, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setText("Guiones");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 470, -1, -1));
        ...
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 470, -1, -1));
        ...
        add(qtyCarroceria, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 500, 30, -1));
        ...
        add(qtyMotores, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 500, 40, -1));
        ...
        qtyRuedas.setText("0");
        add(qtyRuedas, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 500, 30, -1));

        qtyAcc.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        qtyAcc.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        qtyAcc.setText("0");
        add(qtyAcc, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 500, 30, -1));
        ...
        jLabel5.setText("55");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 530, 40, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("35");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 530, 30, -1));

        jLabel24.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel24.setText("10");
        add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 530, 30, -1));
        ...
        workerEnsamblador1.setText("Director");
        add(workerEnsamblador1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 350, -1, 30));

        workerEnsamblador2.setText("Project Manager");
        add(workerEnsamblador2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, -1, 30));
        ...
        add(qtyWEnsamblador1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 310, -1, 30));
        ...
        add(qtyWEnsamblador2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 390, -1, 30));
    ...
    private void qtyWChasisStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWChasisStateChanged
        ...
        valor = Functions.validarCantEmpl(RollsPlant, TipoWorker.guion, valor);
    ...
    private void qtyWMotorStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWMotorStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RollsPlant, TipoWorker.escenario, valor);
    ...
    private void qtyWCarroceriaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWCarroceriaStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RollsPlant, TipoWorker.animador, valor);
    ...
    private void qtyWRuedasStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWRuedasStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RollsPlant, TipoWorker.actor, valor);
    ...
    private void qtyWAccStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWAccStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RollsPlant, TipoWorker.plotwist, valor);
